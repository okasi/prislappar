...
export const TRANSLATIONS = {
  sv: {
    ...
    stampClassic: 'Klassisk Svart Oval (som fotot)',
    ...
    logoCrown: 'Gyllene Kungakrona (som fotot)',
    ...
    bgIceBlue: 'Isblå Delikatess (som fotot)',
  ...
  tr: {
    ...
    stampClassic: 'Klasik Siyah Oval (Fotoğraftaki gibi)',
    ...
    logoCrown: 'Altın Kral Tacı (Fotoğraftaki gibi)',
    ...
    bgIceBlue: 'Buz Mavisi Şarküteri (Fotoğraftaki gibi)',
  ...
  en: {
    ...
    stampClassic: 'Classic Black Oval (like photo)',
    ...
    logoType: 'Logo Icon',
    logoCrown: 'Golden Royal Crown (like photo)',
    ...
    bgIceBlue: 'Ice Blue Deli (like photo)',
